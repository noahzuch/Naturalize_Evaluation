...
public class AllScopeExtractor {
	...
	public static final class AllScopeSnippetExtractor implements
		...
		public AllScopeSnippetExtractor(ScopeCodeSnippetExtractor codeSnippetExtractor) {
			allExtractors = Lists.newArrayList();
			allExtractors
					.add(new VariableScopeExtractor.VariableScopeSnippetExtractor(codeSnippetExtractor));
			allExtractors
		...
		public AllScopeSnippetExtractor(final boolean variables,
			...
			if (variables) {
				allExtractors
						.add(new VariableScopeExtractor.VariableScopeSnippetExtractor(ScopeCodeSnippetExtractor.standard));
			}
			if (methods) {
				allExtractors
						.add(new MethodScopeExtractor.MethodScopeSnippetExtractor(
