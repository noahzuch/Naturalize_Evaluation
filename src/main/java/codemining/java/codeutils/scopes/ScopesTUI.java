...
public class ScopesTUI {
	...
	public static IScopeExtractor getScopeExtractorByName(final String name){
		return getScopeExtractorByName(name,ScopeCodeSnippetExtractor.standard);
	}


	public static IScopeExtractor getScopeExtractorByName(final String name, ScopeCodeSnippetExtractor codeSnippetExtractor)
			throws UnsupportedOperationException {
		final IScopeExtractor scopeExtractor;
		if (name.equals("variable")) {
			scopeExtractor = new VariableScopeExtractor.VariableScopeSnippetExtractor(codeSnippetExtractor);
			...
			scopeExtractor = new AllScopeSnippetExtractor(codeSnippetExtractor);
		} else {
