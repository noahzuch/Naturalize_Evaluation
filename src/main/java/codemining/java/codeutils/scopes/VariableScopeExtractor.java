...
public class VariableScopeExtractor {
	...
	public static final class VariableScopeSnippetExtractor implements
		...
		private final ScopeCodeSnippetExtractor codeSnippetExtractor;

		public VariableScopeSnippetExtractor(ScopeCodeSnippetExtractor codeSnippetExtractor) {
			this.codeSnippetExtractor = codeSnippetExtractor;
		}

		@Override
		public Multimap<Scope, String> getFromFile(final File f)
				throws IOException {
			return getScopeSnippets(f, codeSnippetExtractor);
		}

		@Override
		public Multimap<Scope, String> getFromNode(final ASTNode node) {
			return getScopeSnippets(node, codeSnippetExtractor);
		}

		@Override
		public Multimap<Scope, String> getFromString(final String code,
				final ParseType parseType) {
			return getScopeSnippets(code, parseType, codeSnippetExtractor);
		}
	}
	 ...
	 */
	public static Multimap<Scope, String> getScopeSnippets(final ASTNode cu, ScopeCodeSnippetExtractor codeSnippetExtractor) {
		...
		for (final Entry<ASTNode, Variable> variable : scopeFinder.variableScopes
			...
			scopes.put(
					new Scope(codeSnippetExtractor.extractCodeSnippet(variable.getKey()),
	 ...
	 * @throws IOException
	 */
	public static Multimap<Scope, String> getScopeSnippets(final File file, ScopeCodeSnippetExtractor codeSnippetExtractor)
			throws IOException {
		final JavaASTExtractor ex = new JavaASTExtractor(false);
		return getScopeSnippets(ex.getAST(file), codeSnippetExtractor);
	}
	...
	public static Multimap<Scope, String> getScopeSnippets(final String code,
			final ParseType parseType, ScopeCodeSnippetExtractor codeSnippetExtractor) {
		final JavaASTExtractor ex = new JavaASTExtractor(false);
		return getScopeSnippets(ex.getAST(code, parseType), codeSnippetExtractor);
	}
