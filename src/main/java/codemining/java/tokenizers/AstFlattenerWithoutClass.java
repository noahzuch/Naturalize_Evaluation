...
public class AstFlattenerWithoutClass extends ASTVisitor {
    ...
    protected RewriteEventStore store = new RewriteEventStore();

    public AstFlattenerWithoutClass() {
    ...
    public boolean visit(ArrayCreation node) {
        this.result.append("newArray"); //$NON-NLS-1$
    ...
    public boolean visit(Block node) {
        this.result.append("{\n");
        visitList(node, Block.STATEMENTS_PROPERTY, "\n");
        this.result.append("}\n");
        return false;
    }
    ...
    public boolean visit(SingleVariableDeclaration node) {
        ...
        result.append("var");//getChildNode(node, SingleVariableDeclaration.TYPE_PROPERTY).accept(this);
